...
import { Button, Grid, Paper, Box, AppBar, Toolbar, Typography, IconButton, TextField, InputAdornment, InputLabel, MenuItem, FormControl, Select, ButtonGroup } from '@mui/material';
import { AccountCircle, ExitToAppSharp, CottageRounded } from '@mui/icons-material';

import { styled } from '@mui/material/styles';
import { PaddingDiv, SubHeading, GiftCard, GiftIndexs, GiftIndex, GiftPart, GiftTitle } from './styles';
                    ...
                    {!flag ?
                        (<>
                            ...
                            <Grid item xs={6} style={{ background: "grey" }}>
                                ...
                                <Item style={{ marginBottom: "15px" }}>
                                    <ButtonGroup disableElevation varient="outlined">
                                        <Button size="medium" color="primary" onClick={onSaveGift} varient="outlined">Save Gift Card</Button>
                                        <Button size="medium" color="success" onClick={onPrintPDF} varient="outlined">Print Into PDF</Button>
                                    </ButtonGroup>
                                </Item>
                            </Grid>
                            ...
                            <>
                                ...
                                <Grid item xs={12}><MyDocument giftcontent={giftcontent} /></Grid>
                            </>
                        )
                    }
                </Grid>
